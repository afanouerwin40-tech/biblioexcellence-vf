...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Langue des messages de validation
    |--------------------------------------------------------------------------
    |
    ...
    | versions, comme les règles de taille. N'hésitez pas à les ajuster.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Le champ :attribute a été trouvé dans une fuite de données. Merci de choisir un autre :attribute.',
    ],
    ...
    */
    ...
    'custom' => [
        // 'attribut' => [
        //     'regle' => 'message personnalisé',
        // ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Noms d'attributs personnalisés (spécifiques à BiblioExcellence)
    |--------------------------------------------------------------------------
    |
    | Sans cette section, un message donnerait "Le champ email est
    | obligatoire." Avec, on peut afficher un nom plus naturel.
    |
    */
