        ...
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.authors.index') }}"
                   class="text-xs px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">Auteurs</a>
                <a href="{{ route('admin.categories.index') }}"
                   class="text-xs px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">Catégories</a>
            </div>
        </div>
                            ...
                            <td class="px-6 py-3">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('admin.books.show', $book) }}"
                                       class="text-xs px-3 py-1.5 bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200">Voir</a>
                                    <a href="{{ route('admin.books.edit', $book) }}"
                                       class="text-xs px-3 py-1.5 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100">Modifier</a>
                                    <form method="POST" action="{{ route('admin.books.destroy', $book) }}">
                                        @csrf @method('DELETE')
                                        <button onclick="return confirm('Supprimer ce livre ?')"
